...
import {
  ...
  type VehicleDamageDetailsProps
} from './VehicleDamageDetails';
...
/**
 * connect is still mocked because VehicleDamageDetails.tsx
 * evaluates connect(...) when the module is loaded.
 *
 * The connected component itself is NOT under test.
 */
...
jest.mock('~/feature/claim/car/state', () => ({
  ...
  thunks: {
    getPropertyDamageVehicleModels:
      jest.fn(),

    clearPropertyDamageVehicleModels:
      jest.fn()
  }
}));
 ...
 *
 * These mocks only expose enough information to verify
 * VehicleDamageDetailsComponent wiring and rendering logic.
 */
jest.mock(
