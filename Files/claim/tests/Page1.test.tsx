...
describe('Page1Component', () => {
  ...
  describe('basic rendering', () => {
    ...
    it('renders the page heading', () => {
      ...
      expectHeadingRendered('claim/car:headings.page1');
    });

    it('renders the event location heading', () => {
      renderPage();

      expectHeadingRendered('claim/car:headings.accidentInformation');
    });
  });
  ...
  describe('conditional sections', () => {
    ...
    it('renders other driver section when enabled', () => {
      renderPage({ showOtherDrivers: true });

      expectHeadingRendered('claim/car:headings.driverDetails');
  ...
  describe('next action', () => {
    ...
    it('navigates to car page 2 after submit', async () => {
      ...
      expect(mockNavigate).toHaveBeenCalledWith(routes.CLAIM.CAR.PAGE2);
    });
  });
...
describe('Page1Loader', () => {
  ...
  describe('initialisation', () => {
    ...
    it('initialises page 1 with the current props', () => {
      const lossDate = new Date('2026-08-10T03:00:00.000Z');
      const missingDate = '2026-08-11';
      const makes = ['Honda', 'Ford'];
      const customClaim = { ...claim, claimNumber: 'CLM999' } as Page1Props['claim'];
      ...
      expect(mockInitialisePage1).toHaveBeenCalledWith(lossDate, missingDate, makes, customClaim, true);
    });
  });
